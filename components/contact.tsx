...
export function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:anwrfryd8@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(`Name: ${formData.name}\nEmail: ${formData.email}\n\nMessage:\n${formData.message}`)}`
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+201012886936" className="text-muted-foreground hover:text-accent transition-colors">
                    (+20) 101 288 6936
                  </a>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-accent hover:bg-accent/90 text-black hover:text-black">
